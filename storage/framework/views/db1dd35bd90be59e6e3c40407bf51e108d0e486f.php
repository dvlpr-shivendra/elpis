        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-8 my-auto">
                    ...
                    <h6><?php echo nl2br(e($user->bio)); ?></h6>
                    <p class="text-muted">
            ...
            <?php if($follows->isEmpty()): ?>
                <a href="/follow/<?php echo e($user->id); ?>" class="btn btn-primary float-left mr-2">Follow</a>       
            <?php else: ?>
                <a href="/unfollow/<?php echo e($user->id); ?>" class="btn btn-secondry float-left mr-2">
                    Unfollow
                </a>
            <?php endif; ?>

            <form action="/chat/<?php echo e($user->id); ?>" method="post">
                <?php echo csrf_field(); ?>
